...
function safeError(error) {
  const known = new Set(["VALIDATION_ERROR", "DATABASE_NOT_CONFIGURED", "AUTH_NOT_CONFIGURED", "UNSAFE_URL", "FETCH_FAILED"]);
  return {
    status: error.code === "VALIDATION_ERROR" || error.code === "UNSAFE_URL" ? 400 : error.code === "DATABASE_NOT_CONFIGURED" ? 503 : 500,
