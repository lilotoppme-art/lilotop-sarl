...
async function syncSupplierReplies() {
  ...
  return { mailbox: cfg.mailbox, checked: ids.length, archived, matched, outboundReclassified, lastSyncAt: status?.last_sync_at || null, identities: identityStatus, sendPerformed: false };
}
