...
const { buildSupplierCycle, recordSupplierQuotation } = require("./unops-malawi-rfq");
...
async function prepareUnopsSupplierCycle(id, actorEmail) {
  ...
  const supplierCycle = buildSupplierCycle(schedule.extractedText, dossier.supplierCycle || {});
