...
function buildUnecaSubmissionReview(dossier, credential, organizationChartDocument = null) {
  ...
  const eligibility = [
    ["A", "LILOTOP SARL et ses entites liees ne figurent pas sur les listes de sanctions visees, ou toute situation contraire est divulguee par ecrit", "Proposition OUI sous reserve de la confirmation DG de la liste complete des entites liees; la recherche publique n'a identifie aucun resultat exact LILOTOP SARL", "A CONFIRMER"],
    ["B", "LILOTOP SARL n'a pas ete retiree ou suspendue par l'ONU, une organisation des Nations Unies ou la Banque mondiale", "Proposition OUI sous reserve de la confirmation du statut dans le compte UNGM et par le DG", "A CONFIRMER"],
    ["C", "LILOTOP SARL n'a fait l'objet d'aucune enquete formelle ni sanction pour pratiques proscrites durant les trois dernieres annees", "Proposition OUI sous reserve d'une declaration explicite de la Direction Generale", "A CONFIRMER"],
    ["D", "LILOTOP SARL n'est pas en faillite, en procedure collective ou sous une action susceptible de compromettre ses operations", "Proposition OUI au regard des documents juridiques et fiscaux actifs dans le Coffre, sous reserve de confirmation juridique par le DG", "A CONFIRMER"],
    ["E", "LILOTOP SARL respecte les restrictions post-emploi applicables aux anciens membres du personnel de l'ONU", "Proposition OUI sous reserve de confirmation par la Direction Generale qu'aucune situation incompatible n'existe", "A CONFIRMER"],
    ["F", "LILOTOP SARL s'engage a ne recourir a aucune pratique proscrite et a eviter tout risque indu pour l'ONU", "Proposition OUI; l'engagement peut etre pris mais doit etre valide et signe par le DG", "A CONFIRMER"]
