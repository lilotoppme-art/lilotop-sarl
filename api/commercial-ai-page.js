...
module.exports = function handler(req, res) {
  ...
  const template = fs.readFileSync(path.join(process.cwd(), "admin", "commercial-ai-shell.html"), "utf8");
  const title = authenticated ? "Commercial AI" : "Connexion Commercial AI";
  const html = template
